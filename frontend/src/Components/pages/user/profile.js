                ...
                {orders.map((order) => {
                    return (
                        ...
                        <div className="card mt-2 me-2" >
                            ...
                            {order.type === "H" && <Link to={`/service/cart/home/${order.id}`}>More Details</Link>}
                            {order.type === "S" && <Link to={`/service/cart/shop/${order.id}`}>More Details</Link>}
                            {order.type === "W" && <Link to={`/service/cart/worker/${order.id}`}>More Details</Link>}
